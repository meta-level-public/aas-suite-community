...
{
    /// <summary>
    /// This class represents the ComplexType annotatedRelationshipElement_t
    /// </summary>
    ...
    public partial class AnnotatedRelationshipElement_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for AnnotatedRelationshipElement_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public AnnotatedRelationshipElement_t()
        {
            _elementName = "annotatedRelationshipElement_t";
            Init();
        }

        public AnnotatedRelationshipElement_t(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_First = new tns.Reference_t("first");
            m_Second = new tns.Reference_t("second");
            m_Annotations = null;
        ...
        {
            tns.AnnotatedRelationshipElement_t newObject = new tns.AnnotatedRelationshipElement_t(
                _elementName
            );
            ...
            newObject.m_First = null;
            if (m_First != null)
                newObject.m_First = (tns.Reference_t)m_First.Clone();
            newObject.m_Second = null;
            if (m_Second != null)
                newObject.m_Second = (tns.Reference_t)m_Second.Clone();
            newObject.m_Annotations = null;
            if (m_Annotations != null)
                newObject.m_Annotations = (tns.Annotations)m_Annotations.Clone();
        ...
        public tns.Reference_t First
        {
            get { return m_First; }
            set
            {
                Throw_IfPropertyIsNull(value, "first");
                if (value != null)
                    SetElementName(value, "first");
                m_First = value;
            }
        }
        protected tns.Reference_t m_First;

        #endregion

        #region Attribute - second
        /// <summary>
        /// Represents a mandatory Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        public tns.Reference_t Second
        {
            get { return m_Second; }
            set
            {
                Throw_IfPropertyIsNull(value, "second");
                if (value != null)
                    SetElementName(value, "second");
                m_Second = value;
            }
        }
        protected tns.Reference_t m_Second;

        #endregion

        #region Attribute - annotations
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.Annotations)
        )]
        public tns.Annotations Annotations
        {
            ...
            set
            {
                ...
                {
                    SetElementName(value, "annotations");
                    m_Annotations = value;
                }
            }
        }
        protected tns.Annotations m_Annotations;
