...
{
    /// <summary>
    /// This class represents the ComplexType outputVariables
    /// </summary>
    ...
    public partial class OutputVariables : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for OutputVariables
        /// </summary>
        /// <remarks>
        ...
        {
            _elementName = "outputVariables";
            Init();
        }

        public OutputVariables(string elementName)
        {
        ...
        {
            tns.OutputVariables newObject = new tns.OutputVariables(_elementName);
