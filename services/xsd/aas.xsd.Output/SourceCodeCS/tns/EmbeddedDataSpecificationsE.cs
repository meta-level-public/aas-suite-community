...
namespace tns
{
    ...
    public partial class EmbeddedDataSpecificationsE : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for EmbeddedDataSpecificationsE
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public EmbeddedDataSpecificationsE()
        {
            _elementName = "embeddedDataSpecifications";
            Init();
        }

        public EmbeddedDataSpecificationsE(string elementName)
        {
        ...
        {
            tns.EmbeddedDataSpecificationsE newObject = new tns.EmbeddedDataSpecificationsE(
                _elementName
            );
