...
namespace tns
{
    ...
    public partial class ValueB : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for ValueB
        /// </summary>
        /// <remarks>
        ...
        public ValueB(string elementName)
        {
        ...
        {
            tns.ValueB newObject = new tns.ValueB(_elementName);
