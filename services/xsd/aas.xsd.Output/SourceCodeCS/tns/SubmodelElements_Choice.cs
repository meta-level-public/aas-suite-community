...
{
    /// <summary>
    /// This class represents the Element submodelElements_Choice
    /// </summary>
    ...
    public partial class SubmodelElements_Choice : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SubmodelElements_Choice
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SubmodelElements_Choice()
        {
            _elementName = "submodelElements_Choice";
            Init();
        }

        public SubmodelElements_Choice(string elementName)
        {
        ...
        {
            tns.SubmodelElements_Choice newObject = new tns.SubmodelElements_Choice(_elementName);
