...
{
    /// <summary>
    /// This class represents the ComplexType extensions
    /// </summary>
    ...
    public partial class ExtensionsA : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for ExtensionsA
        /// </summary>
        /// <remarks>
        ...
        public ExtensionsA()
        {
            _elementName = "extensions";
            Init();
        }

        public ExtensionsA(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_Extension = new AasSchema.XmlObjectCollection<tns.Extension_t>(
                "extension",
                "https://admin-shell.io/aas/3/0",
                1,
                -1,
        ...
        {
            tns.ExtensionsA newObject = new tns.ExtensionsA(_elementName);
            foreach (tns.Extension_t o in m_Extension)
                newObject.m_Extension.Add((tns.Extension_t)o.Clone());
        ...
        public AasSchema.XmlObjectCollection<tns.Extension_t> Extension
        {
            get { return m_Extension; }
        }
        protected AasSchema.XmlObjectCollection<tns.Extension_t> m_Extension;
