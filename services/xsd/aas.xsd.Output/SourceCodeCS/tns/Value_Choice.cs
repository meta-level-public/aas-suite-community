...
{
    /// <summary>
    /// This class represents the Element value_Choice
    /// </summary>
    ...
    public partial class Value_Choice : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Value_Choice
        /// </summary>
        /// <remarks>
        ...
        public Value_Choice()
        {
            _elementName = "value_Choice";
            Init();
        }

        public Value_Choice(string elementName)
        {
        ...
        {
            tns.Value_Choice newObject = new tns.Value_Choice(_elementName);
