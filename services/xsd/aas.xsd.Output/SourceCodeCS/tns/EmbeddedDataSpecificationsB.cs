...
namespace tns
{
    ...
    public partial class EmbeddedDataSpecificationsB : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for EmbeddedDataSpecificationsB
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public EmbeddedDataSpecificationsB()
        {
            _elementName = "embeddedDataSpecifications";
            Init();
        }

        public EmbeddedDataSpecificationsB(string elementName)
        {
        ...
        {
            tns.EmbeddedDataSpecificationsB newObject = new tns.EmbeddedDataSpecificationsB(
                _elementName
            );
