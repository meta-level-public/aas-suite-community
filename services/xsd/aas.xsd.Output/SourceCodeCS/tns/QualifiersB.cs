...
namespace tns
{
    ...
    public partial class QualifiersB : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for QualifiersB
        /// </summary>
        /// <remarks>
        ...
        public QualifiersB(string elementName)
        {
        ...
        {
            tns.QualifiersB newObject = new tns.QualifiersB(_elementName);
