...
namespace tns
{
    ...
    public partial class SubmodelsA : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SubmodelsA
        /// </summary>
        /// <remarks>
        ...
        public SubmodelsA(string elementName)
        {
        ...
        {
            tns.SubmodelsA newObject = new tns.SubmodelsA(_elementName);
