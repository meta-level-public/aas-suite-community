...
{
    /// <summary>
    /// This class represents the ComplexType supplementalSemanticIds
    /// </summary>
    ...
    public partial class SupplementalSemanticIdsB : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SupplementalSemanticIdsB
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SupplementalSemanticIdsB()
        {
            _elementName = "supplementalSemanticIds";
            Init();
        }

        public SupplementalSemanticIdsB(string elementName)
        {
        ...
        {
            tns.SupplementalSemanticIdsB newObject = new tns.SupplementalSemanticIdsB(_elementName);
