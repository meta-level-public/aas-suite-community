...
namespace tns
{
    ...
    public partial class SupplementalSemanticIdsA : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SupplementalSemanticIdsA
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SupplementalSemanticIdsA()
        {
            _elementName = "supplementalSemanticIds";
            Init();
        }

        public SupplementalSemanticIdsA(string elementName)
        {
        ...
        {
            tns.SupplementalSemanticIdsA newObject = new tns.SupplementalSemanticIdsA(_elementName);
