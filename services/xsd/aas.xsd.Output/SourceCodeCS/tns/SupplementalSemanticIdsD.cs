...
namespace tns
{
    ...
    public partial class SupplementalSemanticIdsD : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SupplementalSemanticIdsD
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SupplementalSemanticIdsD()
        {
            _elementName = "supplementalSemanticIds";
            Init();
        }

        public SupplementalSemanticIdsD(string elementName)
        {
        ...
        {
            tns.SupplementalSemanticIdsD newObject = new tns.SupplementalSemanticIdsD(_elementName);
