...
{
    /// <summary>
    /// This class represents the ComplexType multiLanguageProperty_t
    /// </summary>
    [LiquidTechnologies.Runtime.XmlObjectInfo(
        ...
        "multiLanguageProperty_t",
        "https://admin-shell.io/aas/3/0",
        true,
        false,
        false
    )]
    public partial class MultiLanguageProperty_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for MultiLanguageProperty_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public MultiLanguageProperty_t()
        {
            _elementName = "multiLanguageProperty_t";
            Init();
        }

        public MultiLanguageProperty_t(string elementName)
        {
        ...
        {
            tns.MultiLanguageProperty_t newObject = new tns.MultiLanguageProperty_t(_elementName);
            ...
            if (m_Value != null)
                newObject.m_Value = (tns.ValueB)m_Value.Clone();
