...
{
    /// <summary>
    /// This class represents the ComplexType annotations
    /// </summary>
    ...
    public partial class Annotations : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        ...
        public Annotations()
        {
            _elementName = "annotations";
            Init();
        }

        public Annotations(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_Annotations_Choice = new AasSchema.XmlObjectCollection<tns.Annotations_Choice>(
                "annotations_Choice",
                "",
                1,
                -1,
        ...
        {
            tns.Annotations newObject = new tns.Annotations(_elementName);
            foreach (tns.Annotations_Choice o in m_Annotations_Choice)
                newObject.m_Annotations_Choice.Add((tns.Annotations_Choice)o.Clone());
        ...
        #region Attribute - annotations_Choice
        /// <summary>
        /// A collection of annotations_Choices
        /// </summary>
        /// <remarks>
        ...
        public AasSchema.XmlObjectCollection<tns.Annotations_Choice> Annotations_Choice
        {
            get { return m_Annotations_Choice; }
        }
        protected AasSchema.XmlObjectCollection<tns.Annotations_Choice> m_Annotations_Choice;
