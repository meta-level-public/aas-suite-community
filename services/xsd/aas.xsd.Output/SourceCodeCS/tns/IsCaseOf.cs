...
{
    /// <summary>
    /// This class represents the ComplexType isCaseOf
    /// </summary>
    ...
    public partial class IsCaseOf : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for IsCaseOf
        /// </summary>
        /// <remarks>
        ...
        public IsCaseOf()
        {
            _elementName = "isCaseOf";
            Init();
        }

        public IsCaseOf(string elementName)
        {
        ...
        {
            tns.IsCaseOf newObject = new tns.IsCaseOf(_elementName);
