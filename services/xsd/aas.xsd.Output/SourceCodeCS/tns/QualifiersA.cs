...
{
    /// <summary>
    /// This class represents the ComplexType qualifiers
    /// </summary>
    ...
    public partial class QualifiersA : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for QualifiersA
        /// </summary>
        /// <remarks>
        ...
        public QualifiersA()
        {
            _elementName = "qualifiers";
            Init();
        }

        public QualifiersA(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_Qualifier = new AasSchema.XmlObjectCollection<tns.Qualifier_t>(
                "qualifier",
                "https://admin-shell.io/aas/3/0",
                1,
                -1,
        ...
        {
            tns.QualifiersA newObject = new tns.QualifiersA(_elementName);
            foreach (tns.Qualifier_t o in m_Qualifier)
                newObject.m_Qualifier.Add((tns.Qualifier_t)o.Clone());
        ...
        public AasSchema.XmlObjectCollection<tns.Qualifier_t> Qualifier
        {
            get { return m_Qualifier; }
        }
        protected AasSchema.XmlObjectCollection<tns.Qualifier_t> m_Qualifier;
