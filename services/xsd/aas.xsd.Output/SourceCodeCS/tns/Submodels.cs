...
{
    /// <summary>
    /// This class represents the ComplexType submodels
    /// </summary>
    ...
    public partial class Submodels : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Submodels
        /// </summary>
        /// <remarks>
        ...
        public Submodels()
        {
            _elementName = "submodels";
            Init();
        }

        public Submodels(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_Submodel = new AasSchema.XmlObjectCollection<tns.Submodel_t>(
                "submodel",
                "https://admin-shell.io/aas/3/0",
                1,
                -1,
        ...
        {
            tns.Submodels newObject = new tns.Submodels(_elementName);
            foreach (tns.Submodel_t o in m_Submodel)
                newObject.m_Submodel.Add((tns.Submodel_t)o.Clone());
        ...
        public AasSchema.XmlObjectCollection<tns.Submodel_t> Submodel
        {
            get { return m_Submodel; }
        }
        protected AasSchema.XmlObjectCollection<tns.Submodel_t> m_Submodel;
