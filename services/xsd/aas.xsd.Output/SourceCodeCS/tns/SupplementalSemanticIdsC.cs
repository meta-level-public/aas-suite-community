...
namespace tns
{
    ...
    public partial class SupplementalSemanticIdsC : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SupplementalSemanticIdsC
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SupplementalSemanticIdsC()
        {
            _elementName = "supplementalSemanticIds";
            Init();
        }

        public SupplementalSemanticIdsC(string elementName)
        {
        ...
        {
            tns.SupplementalSemanticIdsC newObject = new tns.SupplementalSemanticIdsC(_elementName);
