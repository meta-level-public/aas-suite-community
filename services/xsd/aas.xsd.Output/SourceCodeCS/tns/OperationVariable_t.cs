...
{
    /// <summary>
    /// This class represents the ComplexType operationVariable_t
    /// </summary>
    ...
    public partial class OperationVariable_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for OperationVariable_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public OperationVariable_t()
        {
            _elementName = "operationVariable_t";
            Init();
        }

        public OperationVariable_t(string elementName)
        {
        ...
        {
            tns.OperationVariable_t newObject = new tns.OperationVariable_t(_elementName);
            newObject.m_Value = null;
            if (m_Value != null)
                newObject.m_Value = (tns.ValueC)m_Value.Clone();
        ...
        public tns.ValueC Value
        {
            get { return m_Value; }
            set
            {
                Throw_IfPropertyIsNull(value, "value");
                if (value != null)
                    SetElementName(value, "value");
                m_Value = value;
            }
        }
        protected tns.ValueC m_Value;
