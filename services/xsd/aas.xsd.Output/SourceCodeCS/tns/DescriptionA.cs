...
namespace tns
{
    ...
    public partial class DescriptionA : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for DescriptionA
        /// </summary>
        /// <remarks>
        ...
        public DescriptionA(string elementName)
        {
        ...
        {
            tns.DescriptionA newObject = new tns.DescriptionA(_elementName);
