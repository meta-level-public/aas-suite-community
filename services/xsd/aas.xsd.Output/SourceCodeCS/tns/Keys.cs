...
{
    /// <summary>
    /// This class represents the ComplexType keys
    /// </summary>
    ...
    public partial class Keys : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        ...
        public Keys(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_Key = new AasSchema.XmlObjectCollection<tns.Key_t>(
                "key",
                "https://admin-shell.io/aas/3/0",
                1,
                -1,
        ...
        {
            tns.Keys newObject = new tns.Keys(_elementName);
            foreach (tns.Key_t o in m_Key)
                newObject.m_Key.Add((tns.Key_t)o.Clone());
        ...
        public AasSchema.XmlObjectCollection<tns.Key_t> Key
        {
            get { return m_Key; }
        }
        protected AasSchema.XmlObjectCollection<tns.Key_t> m_Key;
