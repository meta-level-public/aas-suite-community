...
{
    /// <summary>
    /// This class represents the ComplexType langStringTextType_t
    /// </summary>
    [LiquidTechnologies.Runtime.XmlObjectInfo(
        ...
        "langStringTextType_t",
        "https://admin-shell.io/aas/3/0",
        true,
        false,
        false
    )]
    public partial class LangStringTextType_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for LangStringTextType_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public LangStringTextType_t()
        {
            _elementName = "langStringTextType_t";
            Init();
        }

        public LangStringTextType_t(string elementName)
        {
        ...
        {
            tns.LangStringTextType_t newObject = new tns.LangStringTextType_t(_elementName);
