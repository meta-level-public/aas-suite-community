...
{
    /// <summary>
    /// This class represents the ComplexType inoutputVariables
    /// </summary>
    ...
    public partial class InoutputVariables : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for InoutputVariables
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public InoutputVariables()
        {
            _elementName = "inoutputVariables";
            Init();
        }

        public InoutputVariables(string elementName)
        {
        ...
        {
            tns.InoutputVariables newObject = new tns.InoutputVariables(_elementName);
