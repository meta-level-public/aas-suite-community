...
namespace tns
{
    ...
    public partial class Value : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        ...
        protected override void Init()
        {
            ...
            m_Value_Choice = new AasSchema.XmlObjectCollection<tns.Value_Choice>(
                "value_Choice",
                "",
                1,
                -1,
        ...
        {
            tns.Value newObject = new tns.Value(_elementName);
            foreach (tns.Value_Choice o in m_Value_Choice)
                newObject.m_Value_Choice.Add((tns.Value_Choice)o.Clone());
        ...
        #region Attribute - value_Choice
        /// <summary>
        /// A collection of value_Choices
        /// </summary>
        /// <remarks>
        ...
        public AasSchema.XmlObjectCollection<tns.Value_Choice> Value_Choice
        {
            get { return m_Value_Choice; }
        }
        protected AasSchema.XmlObjectCollection<tns.Value_Choice> m_Value_Choice;
