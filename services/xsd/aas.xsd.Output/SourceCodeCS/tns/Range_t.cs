...
{
    /// <summary>
    /// This class represents the ComplexType range_t
    /// </summary>
    ...
    public partial class Range_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Range_t
        /// </summary>
        /// <remarks>
        ...
        public Range_t()
        {
            _elementName = "range_t";
            Init();
        }

        public Range_t(string elementName)
        {
        ...
        {
            tns.Range_t newObject = new tns.Range_t(_elementName);
