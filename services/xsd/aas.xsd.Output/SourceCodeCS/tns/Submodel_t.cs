...
{
    /// <summary>
    /// This class represents the ComplexType submodel_t
    /// </summary>
    ...
    public partial class Submodel_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Submodel_t
        /// </summary>
        /// <remarks>
        ...
        public Submodel_t()
        {
            _elementName = "submodel_t";
            Init();
        }

        public Submodel_t(string elementName)
        {
        ...
        {
            tns.Submodel_t newObject = new tns.Submodel_t(_elementName);
            ...
            if (m_SupplementalSemanticIds != null)
                newObject.m_SupplementalSemanticIds = (tns.SupplementalSemanticIdsE)
                    m_SupplementalSemanticIds.Clone();
            newObject.m_Qualifiers = null;
            if (m_Qualifiers != null)
                newObject.m_Qualifiers = (tns.QualifiersB)m_Qualifiers.Clone();
            newObject.m_EmbeddedDataSpecifications = null;
            if (m_EmbeddedDataSpecifications != null)
                newObject.m_EmbeddedDataSpecifications = (tns.EmbeddedDataSpecificationsE)
                    m_EmbeddedDataSpecifications.Clone();
            newObject.m_SubmodelElements = null;
            if (m_SubmodelElements != null)
                newObject.m_SubmodelElements = (tns.SubmodelElements)m_SubmodelElements.Clone();
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqEnumOpt(
            ...
            "ModellingKind_tFromString",
            "ModellingKind_tToString",
            null
        )]
        public tns.Enumerations.ModellingKind_t? Kind
        {
            get { return m_Kind; }
            set { m_Kind = value; }
        }
        protected tns.Enumerations.ModellingKind_t? m_Kind;
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.SupplementalSemanticIdsE)
        )]
        public tns.SupplementalSemanticIdsE SupplementalSemanticIds
        {
        ...
        protected tns.SupplementalSemanticIdsE m_SupplementalSemanticIds;
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.QualifiersB)
        )]
        public tns.QualifiersB Qualifiers
        {
        ...
        protected tns.QualifiersB m_Qualifiers;
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.EmbeddedDataSpecificationsE)
        )]
        public tns.EmbeddedDataSpecificationsE EmbeddedDataSpecifications
        {
        ...
        protected tns.EmbeddedDataSpecificationsE m_EmbeddedDataSpecifications;

        #endregion

        #region Attribute - submodelElements
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.SubmodelElements)
        )]
        public tns.SubmodelElements SubmodelElements
        {
            get { return m_SubmodelElements; }
            set
            {
                if (value == null)
                    m_SubmodelElements = null;
                ...
                {
                    SetElementName(value, "submodelElements");
                    m_SubmodelElements = value;
                }
            }
        }
        protected tns.SubmodelElements m_SubmodelElements;
