...
{
    /// <summary>
    /// This class represents the ComplexType statements
    /// </summary>
    ...
    public partial class Statements : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        ...
        public Statements()
        {
            _elementName = "statements";
            Init();
        }

        public Statements(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_Statements_Choice = new AasSchema.XmlObjectCollection<tns.Statements_Choice>(
                "statements_Choice",
                "",
                1,
                -1,
        ...
        {
            tns.Statements newObject = new tns.Statements(_elementName);
            foreach (tns.Statements_Choice o in m_Statements_Choice)
                newObject.m_Statements_Choice.Add((tns.Statements_Choice)o.Clone());
        ...
        #region Attribute - statements_Choice
        /// <summary>
        /// A collection of statements_Choices
        /// </summary>
        /// <remarks>
        ...
        public AasSchema.XmlObjectCollection<tns.Statements_Choice> Statements_Choice
        {
            get { return m_Statements_Choice; }
        }
        protected AasSchema.XmlObjectCollection<tns.Statements_Choice> m_Statements_Choice;
