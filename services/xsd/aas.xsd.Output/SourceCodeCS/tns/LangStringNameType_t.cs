...
{
    /// <summary>
    /// This class represents the ComplexType langStringNameType_t
    /// </summary>
    [LiquidTechnologies.Runtime.XmlObjectInfo(
        ...
        "langStringNameType_t",
        "https://admin-shell.io/aas/3/0",
        true,
        false,
        false
    )]
    public partial class LangStringNameType_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for LangStringNameType_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public LangStringNameType_t()
        {
            _elementName = "langStringNameType_t";
            Init();
        }

        public LangStringNameType_t(string elementName)
        {
        ...
        {
            tns.LangStringNameType_t newObject = new tns.LangStringNameType_t(_elementName);
