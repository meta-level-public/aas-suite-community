...
namespace tns
{
    ...
    public partial class EmbeddedDataSpecificationsA : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for EmbeddedDataSpecificationsA
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public EmbeddedDataSpecificationsA()
        {
            _elementName = "embeddedDataSpecifications";
            Init();
        }

        public EmbeddedDataSpecificationsA(string elementName)
        {
        ...
        {
            tns.EmbeddedDataSpecificationsA newObject = new tns.EmbeddedDataSpecificationsA(
                _elementName
            );
