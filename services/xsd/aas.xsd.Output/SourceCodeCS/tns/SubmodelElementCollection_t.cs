...
{
    /// <summary>
    /// This class represents the ComplexType submodelElementCollection_t
    /// </summary>
    [LiquidTechnologies.Runtime.XmlObjectInfo(
        ...
        "submodelElementCollection_t",
        "https://admin-shell.io/aas/3/0",
        true,
        false,
        false
    )]
    public partial class SubmodelElementCollection_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SubmodelElementCollection_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SubmodelElementCollection_t()
        {
            _elementName = "submodelElementCollection_t";
            Init();
        }

        public SubmodelElementCollection_t(string elementName)
        {
        ...
        {
            tns.SubmodelElementCollection_t newObject = new tns.SubmodelElementCollection_t(
                _elementName
            );
            ...
            if (m_Value != null)
                newObject.m_Value = (tns.ValueA)m_Value.Clone();
