...
{
    /// <summary>
    /// This class represents the ComplexType file_t
    /// </summary>
    ...
    public partial class File_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for File_t
        /// </summary>
        /// <remarks>
        ...
        public File_t(string elementName)
        {
        ...
        {
            tns.File_t newObject = new tns.File_t(_elementName);
