...
{
    /// <summary>
    /// This class represents the Element value0_Choice
    /// </summary>
    ...
    public partial class Value0_Choice : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Value0_Choice
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public Value0_Choice()
        {
            _elementName = "value0_Choice";
            Init();
        }

        public Value0_Choice(string elementName)
        {
        ...
        {
            tns.Value0_Choice newObject = new tns.Value0_Choice(_elementName);
