...
namespace tns
{
    ...
    public partial class ValueC : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for ValueC
        /// </summary>
        /// <remarks>
        ...
        public ValueC(string elementName)
        {
        ...
        {
            tns.ValueC newObject = new tns.ValueC(_elementName);
