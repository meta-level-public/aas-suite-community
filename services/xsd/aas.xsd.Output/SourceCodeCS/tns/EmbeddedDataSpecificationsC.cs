...
namespace tns
{
    ...
    public partial class EmbeddedDataSpecificationsC : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for EmbeddedDataSpecificationsC
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public EmbeddedDataSpecificationsC()
        {
            _elementName = "embeddedDataSpecifications";
            Init();
        }

        public EmbeddedDataSpecificationsC(string elementName)
        {
        ...
        {
            tns.EmbeddedDataSpecificationsC newObject = new tns.EmbeddedDataSpecificationsC(
                _elementName
            );
