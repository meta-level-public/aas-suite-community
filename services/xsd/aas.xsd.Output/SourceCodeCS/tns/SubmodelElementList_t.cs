...
{
    /// <summary>
    /// This class represents the ComplexType submodelElementList_t
    /// </summary>
    [LiquidTechnologies.Runtime.XmlObjectInfo(
        ...
        "submodelElementList_t",
        "https://admin-shell.io/aas/3/0",
        true,
        false,
        false
    )]
    public partial class SubmodelElementList_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SubmodelElementList_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SubmodelElementList_t()
        {
            _elementName = "submodelElementList_t";
            Init();
        }

        public SubmodelElementList_t(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_OrderRelevant = null;
            m_SemanticIdListElement = null;
            m_TypeValueListElement = tns.Enumerations
                .AasSubmodelElements_t
                .AnnotatedRelationshipElement;
            m_ValueTypeListElement = null;
            m_Value = null;
        ...
        {
            tns.SubmodelElementList_t newObject = new tns.SubmodelElementList_t(_elementName);
            ...
            newObject.m_OrderRelevant = m_OrderRelevant;
            newObject.m_SemanticIdListElement = null;
            if (m_SemanticIdListElement != null)
                newObject.m_SemanticIdListElement = (tns.Reference_t)
                    m_SemanticIdListElement.Clone();
            newObject.m_TypeValueListElement = m_TypeValueListElement;
            newObject.m_ValueTypeListElement = m_ValueTypeListElement;
            newObject.m_Value = null;
            if (m_Value != null)
                newObject.m_Value = (tns.Value)m_Value.Clone();
        ...
        #region Attribute - orderRelevant
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        public bool? OrderRelevant
        {
            ...
            set
            {
                ...
                {
                    m_OrderRelevant = value;
                }
            }
        }
        protected bool? m_OrderRelevant;
        #endregion

        #region Attribute - semanticIdListElement
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        public tns.Reference_t SemanticIdListElement
        {
            get { return m_SemanticIdListElement; }
            set
            {
                if (value == null)
                    m_SemanticIdListElement = null;
                ...
                {
                    SetElementName(value, "semanticIdListElement");
                    m_SemanticIdListElement = value;
                }
            }
        }
        protected tns.Reference_t m_SemanticIdListElement;

        #endregion

        #region Attribute - typeValueListElement
        /// <summary>
        ...
        /// It is defaulted to tns.Enumerations.AasSubmodelElements_t.AnnotatedRelationshipElement;.
        /// </remarks>
        [LiquidTechnologies.Runtime.ElementInfoSeqEnumMnd(
            ...
            "AasSubmodelElements_tFromString",
            "AasSubmodelElements_tToString",
            null
        )]
        public tns.Enumerations.AasSubmodelElements_t TypeValueListElement
        {
            get { return m_TypeValueListElement; }
            set { m_TypeValueListElement = value; }
        }
        protected tns.Enumerations.AasSubmodelElements_t m_TypeValueListElement;

        #endregion

        #region Attribute - valueTypeListElement
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        public tns.Enumerations.DataTypeDefXsd_t? ValueTypeListElement
        {
            get { return m_ValueTypeListElement; }
            set { m_ValueTypeListElement = value; }
        }
        protected tns.Enumerations.DataTypeDefXsd_t? m_ValueTypeListElement;
        ...
        public tns.Value Value
        {
            ...
            set
            {
                ...
                {
                    SetElementName(value, "value");
                    m_Value = value;
                }
            }
        }
        protected tns.Value m_Value;
