...
{
    /// <summary>
    /// This class represents the ComplexType operation_t
    /// </summary>
    ...
    public partial class Operation_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Operation_t
        /// </summary>
        /// <remarks>
        ...
        public Operation_t()
        {
            _elementName = "operation_t";
            Init();
        }

        public Operation_t(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_InputVariables = null;
            m_OutputVariables = null;
            m_InoutputVariables = null;
        ...
        {
            tns.Operation_t newObject = new tns.Operation_t(_elementName);
            ...
            newObject.m_InputVariables = null;
            if (m_InputVariables != null)
                newObject.m_InputVariables = (tns.InputVariables)m_InputVariables.Clone();
            newObject.m_OutputVariables = null;
            if (m_OutputVariables != null)
                newObject.m_OutputVariables = (tns.OutputVariables)m_OutputVariables.Clone();
            newObject.m_InoutputVariables = null;
            if (m_InoutputVariables != null)
                newObject.m_InoutputVariables = (tns.InoutputVariables)m_InoutputVariables.Clone();
        ...
        #region Attribute - inputVariables
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.InputVariables)
        )]
        public tns.InputVariables InputVariables
        {
            get { return m_InputVariables; }
            set
            {
                if (value == null)
                    m_InputVariables = null;
                ...
                {
                    SetElementName(value, "inputVariables");
                    m_InputVariables = value;
                }
            }
        }
        protected tns.InputVariables m_InputVariables;

        #endregion

        #region Attribute - outputVariables
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.OutputVariables)
        )]
        public tns.OutputVariables OutputVariables
        {
            ...
            set
            {
                ...
                {
                    SetElementName(value, "outputVariables");
                    m_OutputVariables = value;
                }
            }
        }
        protected tns.OutputVariables m_OutputVariables;

        #endregion

        #region Attribute - inoutputVariables
        /// <summary>
        /// Represents an optional Element in the XML document
        /// </summary>
        /// <remarks>
        ...
        [LiquidTechnologies.Runtime.ElementInfoSeqClsOpt(
            ...
            "https://admin-shell.io/aas/3/0",
            LiquidTechnologies.Runtime.XmlObjectBase.XmlElementType.Element,
            typeof(tns.InoutputVariables)
        )]
        public tns.InoutputVariables InoutputVariables
        {
            get { return m_InoutputVariables; }
            set
            {
                if (value == null)
                    m_InoutputVariables = null;
                ...
                {
                    SetElementName(value, "inoutputVariables");
                    m_InoutputVariables = value;
                }
            }
        }
        protected tns.InoutputVariables m_InoutputVariables;
