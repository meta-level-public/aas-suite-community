...
namespace tns
{
    ...
    public partial class SupplementalSemanticIdsE : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for SupplementalSemanticIdsE
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public SupplementalSemanticIdsE()
        {
            _elementName = "supplementalSemanticIds";
            Init();
        }

        public SupplementalSemanticIdsE(string elementName)
        {
        ...
        {
            tns.SupplementalSemanticIdsE newObject = new tns.SupplementalSemanticIdsE(_elementName);
