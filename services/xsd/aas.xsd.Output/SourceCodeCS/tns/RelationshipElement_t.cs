...
{
    /// <summary>
    /// This class represents the ComplexType relationshipElement_t
    /// </summary>
    [LiquidTechnologies.Runtime.XmlObjectInfo(
        ...
        "relationshipElement_t",
        "https://admin-shell.io/aas/3/0",
        true,
        false,
        false
    )]
    public partial class RelationshipElement_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for RelationshipElement_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public RelationshipElement_t()
        {
            _elementName = "relationshipElement_t";
            Init();
        }

        public RelationshipElement_t(string elementName)
        {
        ...
        {
            tns.RelationshipElement_t newObject = new tns.RelationshipElement_t(_elementName);
