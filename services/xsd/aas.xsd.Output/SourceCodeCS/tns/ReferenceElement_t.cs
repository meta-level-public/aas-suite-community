...
{
    /// <summary>
    /// This class represents the ComplexType referenceElement_t
    /// </summary>
    ...
    public partial class ReferenceElement_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for ReferenceElement_t
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public ReferenceElement_t()
        {
            _elementName = "referenceElement_t";
            Init();
        }

        public ReferenceElement_t(string elementName)
        {
        ...
        {
            tns.ReferenceElement_t newObject = new tns.ReferenceElement_t(_elementName);
            ...
            if (m_Value != null)
                newObject.m_Value = (tns.Reference_t)m_Value.Clone();
        ...
        protected tns.Reference_t m_Value;
