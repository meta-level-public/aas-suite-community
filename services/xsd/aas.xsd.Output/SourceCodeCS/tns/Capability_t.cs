...
{
    /// <summary>
    /// This class represents the ComplexType capability_t
    /// </summary>
    ...
    public partial class Capability_t : AasSchema.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for Capability_t
        /// </summary>
        /// <remarks>
        ...
        public Capability_t()
        {
            _elementName = "capability_t";
            Init();
        }

        public Capability_t(string elementName)
        {
        ...
        {
            tns.Capability_t newObject = new tns.Capability_t(_elementName);
