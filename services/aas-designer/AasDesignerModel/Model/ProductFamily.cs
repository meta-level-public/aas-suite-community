...
{
    public class ProductFamily : IMetadata, IVerifiable, IHardDeletable
    {
        ...
        public void VerifyDeleteAllowed(AppUser benutzer)
        {
            ...
            if (!allowed)
            {
                throw new OperationNotAllowedException("DELETE_PRODUCT_FAMILY_NOT_ALLOWED");
            }
        }
        ...
        public void VerifyInsertAllowed(AppUser benutzer)
        {
            ...
            if (!allowed)
            {
                throw new OperationNotAllowedException("INSERT_PRODUCT_FAMILY_NOT_ALLOWED");
            }
        }
        ...
        public void VerifyReadAllowed(AppUser benutzer)
        {
            ...
            if (!allowed)
            {
                throw new OperationNotAllowedException("READ_PRODUCT_FAMILY_NOT_ALLOWED");
            }
        }
        ...
        public void VerifyUpdateAllowed(AppUser benutzer)
        {
            ...
            if (!allowed)
            {
                throw new OperationNotAllowedException("UPDATE_PRODUCT_FAMILY_NOT_ALLOWED");
            }
        }
    }
}
