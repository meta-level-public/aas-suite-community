...
@Component({
  selector: 'aas-infrastructure-add',
  imports: [
    TableModule,
    FieldsetModule,
    TranslateModule,
  ...
  styleUrls: ['../../../../host.scss'],
  providers: [{ provide: HasChangesCheckable, useExisting: InfrastructureAddComponent }],
})
export class InfrastructureAddComponent extends HasChangesCheckable {
