...
export const AasSuitePreset = definePreset(Lara, {
  primitive: {
    borderRadius: {
      none: '0',
      xs: '2px',
  ...
  extend: {
    ...
    'customer-logo': '',
    'background-image': 'linear-gradient(90deg, #039be5, #01579b)',
    'background-image-dark': 'linear-gradient(90deg, var(--p-cyan-700), var(--p-cyan-900))',
    'topbar-button-border': '0',
    'topbar-button-border-color': '#ffffff',
    'topbar-button-background-color': '#fff3 !important',
